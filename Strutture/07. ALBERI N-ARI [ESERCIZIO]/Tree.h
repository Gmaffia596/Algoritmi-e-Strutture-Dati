...
template<class I, class N>
 ...
 public:
	...
	//template<class V> void BFS(node) = 0;
	//template<class V> void preorder(node) = 0;
	//template<class V> void postorder(node) = 0;
	
	//per esercizio
	//virtual int profondita(node)=0;					//FUNZIONE CHE DATO UN NODO RADIOCE NE RESTITUISCE LA LUNGHEZZA MASSIMO FINO AD ARRIVARE ALLE FOGLIE
