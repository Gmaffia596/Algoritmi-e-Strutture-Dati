...
template < class T > class CodaP //generalizzo per il tipo di elemento passato
{

public: //metodi pubblici
  typedef T _tipoelem;
  CodaP (); //costruttore con nulla
  CodaP (int); //costruttore passante un intero
  ~CodaP (); //distruttore dell'oggetto
